...
<?php
// if $category_filter is 0 then we only take in the value of $_GET["page"] //
...
<div class="widget dashboard-container my-adslist">
  ...
  <div class="filter-container d-flex">
    <div class="form-group has-search d-inline-block">
      ...
      <input type="text" class="search form-control" id="admin-search-product" oninput="searchProduct()" style="height:40px!important; width:34vw;" placeholder="Search">
    </div>
    <select class="role-select d-inline-block" id="category-type" name="category-types" style="margin-left: 10px; width:300px; height:40px;" onchange="categoryFilter()">
      ...
      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
          ...
          // if the $_GET["category_filter"] is equal as the selected option, then call it as selected //
...
<?php
  ...
  <div class="pagination justify-content-center">
    <nav aria-label="Page navigation example">
      <ul class="pagination">
        <li class="page-item">
          <a class="page-link" onclick="productTable(this)" aria-label="Previous" id="'.$category.'" value="';
        ...
        echo
        '"><a class="page-link" onclick="productTable(this)" id="'.$category.'" value="1">1</a></li>';
        ...
        for ($n = 2; $n <= $page_numb; $n++) {
          ...
          echo '"><a class="page-link" onclick="productTable(this)" id="'.$category.'" value="'.$n.'">'.$n.'</a></li>';
        }

        echo
        '<li class="page-item">
          <a class="page-link" onclick="productTable(this)" aria-label="Next" id="'.$category.'" value="';
