...
<head>
  ...
  <title> Profile Page | Shoppa </title>
		...
		<div class="row">
			<div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-profile">
						...
						<!-- User Name -->
						<h5 id="page-user" class="text-center"></h5>
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">Profile Detail</h3>
					<div class="table table-responsive product-dashboard-table">
						<div id="user-detail" style="text-align:justify;">
	...
	$(window).on("load", function() {
		...
		$.ajax({
			...
			success: function(response){
				$("#user-detail").html(response).show();
			}
		});
