                ...
                <div class="border">
                    ...
                    <form>
                        <fieldset class="p-4">
                            ...
                            <input id="pass" type="password" placeholder="Password" class="border p-3 w-100 my-2">
                            <button id="btnLogin" type="button" class="d-block py-3 px-5 bg-primary text-white border-0 rounded font-weight-bold mt-3">Log in</button>
                            <a class="mt-3 d-block  text-primary" href="forget_password.php">Forget Password?</a>
